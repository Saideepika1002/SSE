...
<form class="modal-content animate" action="" method="post">
		<div> 
        <label for="password"><b>FILE-ID:</b></label>
...
<?php
if(isset($_POST['submit'])&&!empty($_POST['pass'])&&!empty($_POST['id']))
{   $fileid=$_POST['id'];
...
//fetch_comment.php
$query=mysqli_query($con,"SELECT * FROM sharedfiles WHERE fileid='".$fileid."'");
